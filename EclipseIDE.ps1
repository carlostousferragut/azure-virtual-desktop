...
$installerUrl = "https://mirror.umd.edu/eclipse/technology/epp/downloads/release/2024-12/R/eclipse-jee-2024-12-R-win32-x86_64.zip"  # Puedes cambiarlo si hay nueva versión
